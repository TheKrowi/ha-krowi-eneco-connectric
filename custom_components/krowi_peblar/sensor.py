...
async def async_setup_entry(
    ...
    coordinator: KrowiPeblarCoordinator = hass.data[DOMAIN][entry.entry_id]
    async_add_entities(
        KrowiPeblarSensor(coordinator, entry, description)
        for description in SENSOR_DESCRIPTIONS
    )


def _build_device_info(
    coordinator: KrowiPeblarCoordinator, entry: ConfigEntry
) -> DeviceInfo:
    ...
    return DeviceInfo(
        ...
        manufacturer="Peblar",
        model=data.get("sProductNumberAddress"),
        sw_version=data.get("sFwIdentifierAddress"),
        serial_number=data.get("sSerialNumberAddress"),
    )
